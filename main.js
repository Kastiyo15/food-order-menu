...
const el_add_to_cart_btn = el_add_to_cart.querySelector(".add-to-cart-button"); // add to cart button
const el_checkout_button = document.querySelector(".checkout-button-container");
